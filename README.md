...
* Expanding-cards showcases 8 cards that retract and expand depending on which card you have current clicked on. The cards are all photos stacked together. There is one active photo meaning that the full photo is visible. When you click on the inactive photos they become active and will show the full image. The page is dynamic and will shrink down for mobile users.  
